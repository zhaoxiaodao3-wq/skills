# 热力空状态预设科目 Implementation Plan

**Spec:** [../specs/01-dev-spec.md](../specs/01-dev-spec.md)

**Goal:** 空状态展示预设科目全 0，有数据按接口展示。

**Architecture:** `buildEmptyHeatmap` 用 `HEATMAP_SUBJECTS`，adapter 保持动态。
...
- [x] Step 1: `buildEmptyHeatmap` 生成 9×20 全 0 矩阵

### Task 2：验证与交付收尾

**Files:**
- Modify: `specs/01-dev-spec.md`、`plans/01-dev-plan.md`
- Create: `archive/热力空状态预设科目-delivered.md`
